@extends('layouts.app')
@section('content')
   <a href="{{route('players.create')}}" class="btn btn-info waves-effect waves-light" style="margin: 0 0 30px;border-radius: 50px;">
    {{trans('messages.añadir_jugador')}}
    </a>
   @forelse($players as $player)
    <li class="list-group-item jugador">
