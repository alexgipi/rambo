    <nav class="mb-1 navbar navbar-expand-lg navbar-dark info-color">
        <a class="navbar-brand" href="{{url('/')}}">{{trans('messages.Proyecto')}}</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
            <ul class="navbar-nav ml-auto">
                    @if(Auth::user() == "")
                    <li class="nav-item">
                        <a class="btn-registro nav-link waves-effect waves-light" id="navbarDropdownMenuLink-4" href="{{route('register')}}" aria-haspopup="true" aria-expanded="true">
                            <i class="fas fa-user"></i> Registro
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="btn-login nav-link waves-effect waves-light" id="navbarDropdownMenuLink-4" href="{{route('login')}}" aria-haspopup="true" aria-expanded="true">
                            <i class="fas fa-user"></i> {{trans('messages.login')}}
                        </a>
                    </li>
                ...
                <!-- lang -->
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="navbarDropdownMenuLink-4">
                            <a href="{{route('logout')}}">
                                <span class="dropdown-item waves-effect waves-light">
                                    <i class="fas fa-sign-out-alt" style="margin-right:10px;"></i>{{trans('messages.cerrarsesion')}}
                                </span>
                            </a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link waves-effect waves-light" href="#contacto">
                            <i class="fas fa-envelope"></i> {{trans('messages.contacto')}}
                        </a>
                    </li>
                    <li class="nav-item">
