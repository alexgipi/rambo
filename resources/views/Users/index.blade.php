@extends('layouts.app')
@section('content')
    <a href="{{route('users.create')}}" class="btn btn-info waves-effect waves-light" style="margin: 0 0 30px;border-radius: 50px;">
        {{trans('messages.Añadir_usuario')}}
    </a>
<div class="col-md-12 card">
    ...
    <div class="row">
        ...
        <div class="col-md-1">
                <a class="btn btn-warning" href="{{route('user.edit', Auth::user()->id)}}">{{trans('messages.modificar')}}</a>
        ...
        <hr>
        @elseif(Auth::user()->user_type_id == 2 && $user->user_type->id == 2)
            @else
            <div class="row">
                <div class="col-md-1">
                    <p>{{$user->name}}</p>
